 ...
 *
 * userIdToUser is a Map from userId to User
 */
public class UserManager implements IAccountManager{
     ...
     */
    public List<String> userIdsByStatus(UserStatus status) {
    ...
    /**
     * Returns the user status of the user with this userId
    ...
    public UserStatus statusByUserId(String userId) {
        return findAccountById(userId).getStatus();
    }

    /**
     * Returns an inventory of item IDs associated with this userId
     * @param userId the user ID of a user
     * @return a LList of strings representing inventory of item IDs belonging to this user ID
     */
    public List<String> inventoryByUserId(String userId) {
    ...
    /**
     * Changes the status of a user with this userId
     * @param userId the user ID of a user
     * @param status the status of a user
     */
    public void changeStatus(String userId, UserStatus status) {
        if (findAccountById(userId)==null) return;
        findAccountById(userId).setStatus(status);
    }
    ...
    /**
     * Request userId to be unfrozen
     * @param userId the user ID of the user
     * @return true iff the userId can request to be unfrozen (iff the userId's status is FROZEN)
     */
    public boolean unfreezeRequest(String userId) {
        if (findAccountById(userId).getStatus().equals(UserStatus.FROZEN)) {
    ...
    public ArrayList<String> userIdsSameCity(String city, String country) {
        ...
        for (Map.Entry <String, User> entry : getUserIdToUser().entrySet()) {
            String[] cityAndCountry = entry.getValue().getCityAddress().split("-");
    ...
    public String findPlaceByUserId(String userId) {
        return findAccountById(userId).getCityAddress();
    }
